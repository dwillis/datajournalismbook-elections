...
(This guide is done using a Mac. Windows machines will be a little different, mainly because you'll have more choices in most menus. The Mac CMD key is the same as the Windows CTL key.)
...
![](images/xl-refresher-battleship.png)
:::
...
|                                                                                                                                                                                          |                                                |
|------------------------------------------------------|------------------|
| **BFWPS**: The Big Fat White Plus Sign. This is the default shape, and you can never get into trouble when you see it                                                                    | ![BFwPS](images/xl-refresher-bfwps.png)        |
...
![ready](images/xl-refresher-screen1.png){width="100%"}

This is how it changes when you're editing

![editing](images/xl-refresher-screen2.png){width="100%"}
...
![freeze panes](images/xl-refresher-freezepanes.png){width="100%"}
...
These first steps, along with adding an ID row, are shown [here](https://www.youtube.com/embed/iGCpfop0zvs?rel=0). You can [follow along with the same dataset](https://cronkitedata.s3.us-west-1.amazonaws.com/xlfiles/phoenix_salaries.xlsx).
...
![options](images/xl-refresher-options.png){width="60%" height="60%"}
