...
::: {.alert .alert-info } - [Data from the Washington Post](https://cronkitedata.s3.amazonaws.com/xlfiles/wapo-shootings-filter.xlsx) for use in this tutorial - [Documentation from the Post's github site](https://github.com/washingtonpost/data-police-shootings#about-the-data) :::
...
-   **Date and times**: These are actual dates on the calendar, which have magical properties. Underneath, they are a number. In Excel, that number is the number of days since Jan. 1, 1900.[^xl-filter-sort-2] They can also have time attached to them, which in Excel is a fraction of a day. What this means is that the number 44,536.5 is really Dec. 6, 2021 at noon. In Excel, you use a format to tell the spreadsheet how you want to see the date or time, just the way you look at dollar values with commas and symbols. (If you get a spreadsheet with a lot of dates of 1/1/1900, it means there is a 0 in that column, which is sometimes a fill-in for "I don't know.")
...
![](images/xl-filter-sort-table.gif)
...
![](images/xl-filter-sort-sortbox.png){width="100%"}
...
![](images/xl-filter-sort-state.png){width="100%"}
...
![](images/xl-filter-sort-onefilter.gif)
...
![](images/xl-filter-sort-unarmed-fleeing.gif)
...
![](images/xl-filter-sort-filter-options.png){width="100%"}
...
### How do I turn off all of my sort and filters {.unnumbered}
...
### I'm getting weird questions and alerts about sorting {.unnumbered}
...
![filter date](images/xl-filter-sort-faq1.png)
...
### I want to get rid of my data table {.unnumbered}
