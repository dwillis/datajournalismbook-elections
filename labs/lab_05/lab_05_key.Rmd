...
* A slice of federal campaign contribution data from College Park (lab_05.rds).
...
```{r}
# Load the College Park contributions data table
college_park_contributions <- read_rds('data/lab_05.rds')
