...
```
**Q2.** Let's do some research on the top purposes from A1. Feel free to search the Web to understand those terms better, and then write a description comparing and contrasting the two campaigns' largest categories of spending. 

**A2.** 

**Q3.** Pick one of the top categories for each campaign and write code that shows how that spending has changed over time, if at all. Write a couple of sentences describing that pattern.
...
**Q4.** Which committee has the larger payroll or salary spending so far?
...
**Q5** What's the best story idea you've found in this data?
