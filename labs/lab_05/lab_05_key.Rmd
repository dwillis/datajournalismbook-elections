...
md_senate_expenses_cleaned <- read_csv("data/md_senate_exp.csv")
...
**A2.** Both campaigns have spent heavily on advertising (media), but Alsobrooks has spent more on staff and online advertising specifically (it's not clear from Hogan's spending if his ads are online or broadcast). Alsobrooks also seems to have spent more money on fundraising.
