...
```{r}
# Removals
removals <- read_csv("data/removals.csv") %>% clean_names()
...
```{r}
# Changes
changes <- read_csv("data/changes.csv") %>% clean_names()
