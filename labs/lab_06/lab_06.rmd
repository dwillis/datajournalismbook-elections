...
Do all of that again, for the [September 2020 voter registration update](https://elections.maryland.gov/pdf/vrar/2020_09.pdf), so we can compare the two. If you've done well, this is easy: just do the same steps in Tabula, export the files and use the same code to read in and clean up the data, *but remember to give these dataframes slightly different names*, although similar enough so that you know how to compare September 2022 to September 2020.

To answer the following questions, you'll need to calculate percentages and do other calculations. Whether you do that after combining or joining dataframes or you write code to run separately on both is up to you, but joining _would_ make it easier.
