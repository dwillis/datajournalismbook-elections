...
**Task** Run the following code to extract the table we want, clean up the names and remove the total row. Look at the rename() function - what do you think the numbers 2, 3 and 4 are referring to? **Answer**
...
**Task** Right-click on the first red dot next to "Agriculture" and choose "Inspect". You should see multiple
...
tags, but we have lots of them, and it's hard to see any of the committees. Let's see what we're dealing with and just look at the text *inside* the
...
tags into a dataframe **Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer**
