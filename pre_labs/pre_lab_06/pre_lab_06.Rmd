...
**Task** Here's a slightly more involved PDF, from our Missouri primary election collection efforts! It's from [Camden County](https://drive.google.com/file/d/1PcsvFpkulCZUM6bnEM74cttf3W0WWC0U/view?usp=sharing).

```{r, echo=FALSE}
knitr::include_graphics(rep("images/camden.png"))
```
