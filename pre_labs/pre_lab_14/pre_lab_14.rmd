...
While "covid 19" is still a top phrase, it's not _the_ leading phrase any longer. You'll notice that the percentages are very small; that's not irrelevant but in some cases it's the differences in patterns that's more important.
...
### Task 15: Load the bing lexicon and produce sentiments for our 2021 and 2022 unique words
