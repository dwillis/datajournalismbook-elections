...
In the space below, write the data type for the "name" column and the "amount" column (it's in light gray, offset by \< \>). Also offer your best guess as to what the "name" column and the "amount" column represent. **Answer**
