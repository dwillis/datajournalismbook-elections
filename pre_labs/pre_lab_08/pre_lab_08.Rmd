...
**Task** Run the following code to create a dataframe of top 10 counties with the biggest change in registered voters in Maryland. In the space below, explain what each step of the code below is doing in English. **Answer**
