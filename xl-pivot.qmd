...
To get totals for out of state contributions to Maryland's 2022 gubernatorial primary candidates, Stephen Neukam downloaded data from the State Board of Elections for candidates including Wes Moore and other candidates.
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/P_udA-XFpGY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
...
![](images/xl-pivot-success.png){width="100%"}
...
![](images/xl-pivot-percentcolumn.png){width="100%"}
...
![](images/xl-pivot-twovariables.png){width="100%"}
...
![badsort](images/xl-pivot-badsort.png){width="100%"}
